...
interface CreateClientProps {
    ...
    defaultNodeKeySeedProp?: string;
}

const CreateClient: React.FC<CreateClientProps> = ({ userKey, setClient, defaultNodeKeySeedProp }) => {
    const [seed, setSeed] = useState<string>('');
    const defaultNodeKeySeed = defaultNodeKeySeedProp || `my_coin_predict_seed`;
